#!/usr/bin/env python3
"""
OOS 2025 Q4 Backtest Runner — Out-of-Sample Validation (Sep-Dec 2025)
Same config as YTD V2 runner, different date range.
...
def generate_report(results):
    ...
    report_path = os.path.join(WORKDIR, "OOS_2025Q4_BACKTEST_RESULTS.md")
