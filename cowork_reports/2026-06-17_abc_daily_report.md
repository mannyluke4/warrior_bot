...
|---|---|---:|---:|---:|---:|---:|---:|
| A | FIRESTORM-gate | +$3,000.00 | +$0.00 | 0 / 0 | 0 | 31003 | 0 |
| B | FIRESTORM-gate + Track A | err: {"message": "unautho | err: {"message": "unautho | err: {"message": "unautho | — | — | — |
| C | REENTRY-loss-gate | +$3,000.00 | +$0.00 | 0 / 0 | 7 | 44193 | 0 |
...
- FIRESTORM-gate blocks: 31003 (2 unique symbols)

### Variant B — FIRESTORM-gate + Track A

- log error: `no_log` (path: `/Users/duffy/warrior_bot_v2/logs/2026-06-17_move_strike_subbot_B.log`)
...
- FIRESTORM-gate blocks: 44192 (2 unique symbols)
- Symbols traded: EHGO

## Data Quality Audit

- Audit lines parsed: 4156
...
|---|---:|---:|---:|---:|---|
| LNAI | 696 | 3 | 1 | 0.000 | 11175 / 9080 |
| CLWT | 836 | 0 | 1 | 0.000 | 30530 / 40661 |
| UTSI | 680 | 125 | 0 | 0.152 | 1514 / 9970 |
