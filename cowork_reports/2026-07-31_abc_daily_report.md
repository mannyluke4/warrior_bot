...
|---|---|---:|---:|---:|---:|---:|---:|
| A | FIRESTORM-gate | +$4,589.68 | -$249.03 | 4 / 8 | 4 | 0 | 0 |
| B | FIRESTORM-gate + Track A | err: {"message": "unautho | err: {"message": "unautho | err: {"message": "unautho | — | — | — |
| C | REENTRY-loss-gate | +$1,817.41 | +$0.00 | 0 / 0 | 0 | 8980 | 0 |
...
- Symbols traded: FCUV, SKDD

### Variant B — FIRESTORM-gate + Track A

- log error: `no_log` (path: `/Users/duffy/warrior_bot_v2/logs/2026-07-31_move_strike_subbot_B.log`)
...
- Regime-shift partials fired: 0
- Fade-gate blocks: 0 (0 unique symbols)
- FIRESTORM-gate blocks: 8980 (1 unique symbols)

## Data Quality Audit

- Audit lines parsed: 3411
...
|---|---:|---:|---:|---:|---|
| SKDD | 457 | 7 | 1 | 0.010 | 16013 / 5944 |
| SNXX | 464 | 0 | 1 | 0.031 | 242990 / 241851 |
| MODD | 127 | 51 | 0 | 1.717 | 801 / 300 |
| LFS | 419 | 49 | 0 | 0.176 | 10200 / 4390 |
| AXTX | 462 | 3 | 0 | 0.255 | 28318 / 5566 |
