...
|---|---|---:|---:|---:|---:|---:|---:|
| A | FIRESTORM-gate | +$6,226.36 | +$1,020.33 | 2 / 4 | 2 | 0 | 0 |
| B | FIRESTORM-gate + Track A | err: {"message": "unautho | err: {"message": "unautho | err: {"message": "unautho | — | — | — |
| C | REENTRY-loss-gate | +$1,724.54 | +$0.00 | 0 / 0 | 0 | 0 | 0 |
...
- Symbols traded: CBRG, COIG

### Variant B — FIRESTORM-gate + Track A

- log error: `no_log` (path: `/Users/duffy/warrior_bot_v2/logs/2026-07-21_move_strike_subbot_B.log`)
...
|---|---:|---:|---:|---:|---|
| TSLG | 581 | 53 | 2 | 0.001 | 4607 / 100 |
| GREE | 615 | 20 | 1 | 0.087 | 3448 / 6253 |
| CBRG | 623 | 12 | 1 | 0.036 | 21676 / 3500 |
| SNXX | 681 | 0 | 1 | 0.083 | 84771 / 66457 |
