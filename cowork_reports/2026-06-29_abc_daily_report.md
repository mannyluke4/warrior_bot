...
|---|---|---:|---:|---:|---:|---:|---:|
| A | FIRESTORM-gate | +$2,394.50 | -$314.34 | 2 / 4 | 2 | 22324 | 1 |
| B | FIRESTORM-gate + Track A | err: {"message": "unautho | err: {"message": "unautho | err: {"message": "unautho | — | — | — |
| C | REENTRY-loss-gate | +$2,370.23 | -$330.77 | 2 / 4 | 2 | 22324 | 1 |
...
- FIRESTORM-gate blocks: 22323 (2 unique symbols)
- Symbols traded: UPC

### Variant B — FIRESTORM-gate + Track A

- log error: `no_log` (path: `/Users/duffy/warrior_bot_v2/logs/2026-06-29_move_strike_subbot_B.log`)
...
|---|---:|---:|---:|---:|---|
| UPC | 978 | 0 | 1 | 0.000 | 10748 / 7547 |
| DCOY | 994 | 19 | 0 | 0.387 | 2805 / 2295 |
