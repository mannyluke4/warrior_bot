...
- log error: `no_log` (path: `/Users/duffy/warrior_bot_v2/logs/2026-07-09_move_strike_subbot_A.log`)

### Variant B — FIRESTORM-gate + Track A

- log error: `no_log` (path: `/Users/duffy/warrior_bot_v2/logs/2026-07-09_move_strike_subbot_B.log`)

### Variant C — REENTRY-loss-gate

- log error: `no_log` (path: `/Users/duffy/warrior_bot_v2/logs/2026-07-09_move_strike_subbot_C.log`)
