...
|---|---|---:|---:|---:|---:|---:|---:|
| A | FIRESTORM-gate | +$5,322.82 | -$286.83 | 1 / 2 | 3 | 0 | 0 |
| B | FIRESTORM-gate + Track A | err: {"message": "unautho | err: {"message": "unautho | err: {"message": "unautho | — | — | — |
| C | REENTRY-loss-gate | +$1,724.54 | +$0.00 | 0 / 0 | 0 | 3038 | 0 |
...
- log error: `no_log` (path: `/Users/duffy/warrior_bot_v2/logs/2026-07-28_move_strike_subbot_B.log`)
...
- Regime-shift partials fired: 0
- Fade-gate blocks: 0 (0 unique symbols)
- FIRESTORM-gate blocks: 3038 (1 unique symbols)

## Data Quality Audit

- Audit lines parsed: 1047
