...
|---|---|---:|---:|---:|---:|---:|---:|
| A | FIRESTORM-gate | +$5,000.00 | +$0.00 | 0 / 0 | 0 | 974 | 0 |
| B | FIRESTORM-gate + Track A | err: {"message": "unautho | err: {"message": "unautho | err: {"message": "unautho | — | — | — |
| C | REENTRY-loss-gate | +$1,724.54 | +$0.00 | 0 / 0 | 0 | 974 | 0 |
...
- FIRESTORM-gate blocks: 974 (1 unique symbols)

### Variant B — FIRESTORM-gate + Track A

- log error: `no_log` (path: `/Users/duffy/warrior_bot_v2/logs/2026-07-17_move_strike_subbot_B.log`)
...
|---|---:|---:|---:|---:|---|
| KLRS | 181 | 158 | 1 | 0.010 | 4500 / 533 |
| SKHX | 327 | 0 | 1 | 0.000 | 21698 / 22133 |
| SNXX | 339 | 0 | 1 | 0.099 | 55927 / 45505 |
| LEDS | 266 | 74 | 0 | 0.130 | 61215 / 10000 |
