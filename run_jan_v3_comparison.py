#!/usr/bin/env python3
"""
January 2025 vs January 2026 — V3 (SQ + Ross Coexistence)
======================================================
...
Fresh start: uses jan_comparison_v3_state.json (NOT V1 state).
"""
...
STATE_FILE = os.path.join(WORKDIR, "jan_comparison_v3_state.json")
REPORT_FILE = os.path.join(WORKDIR, "cowork_reports", "2026-03-23_jan_comparison_v3.md")
